...
# -*- coding: utf-8 -*-
#
# aiolambda documentation build configuration file, created by
...
html_theme = 'aiolambda_theme'

# Theme options are theme-specific and customize the look and feel of a theme
# further.  For a list of options available for each theme, see the
# documentation.
html_theme_options = {
    'logo': 'aiolambda-icon-128x128.png',
    ...
    'github_type': 'star',
    'github_banner': True,
    'badges': [{'image': 'https://travis-ci.com/pando85/aiolambda.svg?branch=master',
                'target': 'https://travis-ci.com/pando85/aiolambda',
                'height': '20',
...
htmlhelp_basename = 'aiolambdadoc'
...
latex_documents = [
    ('index', 'aiolambda.tex', 'aiolambda Documentation',
     'aiolambda contributors', 'manual'),
]
